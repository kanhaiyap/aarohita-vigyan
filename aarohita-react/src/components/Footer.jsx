      ...
      <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              >
                <img
                  ...
                  draggable="false"
                />
                <span className="sr-only">Aarohita Vigyan</span>
              </a>
            </div>

            <p className="text-slate-600 mb-6 max-w-md">
              Transforming businesses with cutting-edge AI and IoT solutions.
        ...
        <div className="border-t border-slate-200 mt-12 pt-8 text-center">
          <p className="text-slate-600">
            &copy; {year} Aarohita Vigyan Pvt. Ltd. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
